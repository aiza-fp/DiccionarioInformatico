...
public class Diccionario {
	...
	public static void main(String[] args) {
		...
		if(palabra != null && palabra.equalsIgnoreCase("backbone")) {
		...
		else if (palabra!= null && palabra.equalsIgnoreCase("WLAN")) {
			System.out.println("Significado:");
			System.out.println("Una LAN inalámbrica (WLAN) es un tipo de red de área local (LAN) que utiliza la comunicación inalámbrica para conectar cualquier tipo de dispositivo o cliente de red.");
		}

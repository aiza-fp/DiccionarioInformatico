...
public class Diccionario {
	...
	public static void main(String[] args) {
		...
		if(palabra != null && palabra.equalsIgnoreCase("bit")) {
			...
			System.out.println("La memoria de acceso aleatorio es una memoria de almacenamiento a corto plazo. El sistema operativo de ordenadores u otros dispositivos utiliza la memoria RAM para almacenar de forma temporal todos los programas y sus procesos de ejecución​.");
		}

...
public class Diccionario {
	...
	public static void main(String[] args) {
		...
		}else if (palabra != null && palabra.equalsIgnoreCase("workspace")) {
			System.out.println("Workspace is a term used in various branches of engineering and economic development.");
		}
